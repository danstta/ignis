/**
 * Shared hardening helpers for the public webhook ingest route
 * (/api/hooks): header redaction before payloads are persisted or
 * forwarded into runs, and size-capped body reads.
 */
